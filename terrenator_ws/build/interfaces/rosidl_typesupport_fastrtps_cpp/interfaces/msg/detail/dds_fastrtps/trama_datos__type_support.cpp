...
#include "interfaces/msg/detail/trama_datos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::TramaDatos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::TramaDatos & ros_message)
{
  // Member: u_m
  {
    cdr >> ros_message.u_m;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::TramaDatos;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::TramaDatos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::TramaDatos *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_TramaDatos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, TramaDatos)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_TramaDatos__handle;
}
