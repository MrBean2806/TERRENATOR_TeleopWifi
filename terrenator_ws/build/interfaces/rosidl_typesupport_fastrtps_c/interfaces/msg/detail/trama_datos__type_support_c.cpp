...
#include "interfaces/msg/detail/trama_datos__rosidl_typesupport_fastrtps_c.h"
...
using _TramaDatos__ros_msg_type = interfaces__msg__TramaDatos;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__TramaDatos;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__TramaDatos * ros_message = static_cast<const interfaces__msg__TramaDatos *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__TramaDatos(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__TramaDatos * ros_message = static_cast<interfaces__msg__TramaDatos *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__TramaDatos(cdr, ros_message);
}

static uint32_t _TramaDatos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__TramaDatos(
...
static size_t _TramaDatos__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__TramaDatos(
